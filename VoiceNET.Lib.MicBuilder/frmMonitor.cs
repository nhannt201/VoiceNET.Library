...
namespace VoiceNET.Lib.MicBuilder
{
    public partial class frmMonitor : Form
    {
        ...
        {
            if (String.IsNullOrEmpty(VBuilder.getPathDataset())) MessageBox.Show("You cannot use this feature without first setting up a dataset. Please select the dataset folder in the settings section.", "MessageBox");
            ...
            
            {
                ...
                
                {
                    ...
                    if (!lstAdded.Items.Contains(txtLabelPre.Text)) lstAdded.Items.Add(txtLabelPre.Text);
